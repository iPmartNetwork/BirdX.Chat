...
export function DesktopSettingsModal({
  ...
  return createPortal(
    <div className="fixed inset-0 z-[140] flex items-center justify-center bg-black/40 px-6">
      <div className="flex max-h-[calc(100dvh-2rem)] w-full max-w-md flex-col overflow-hidden rounded-2xl border border-indigo-100/70 bg-white shadow-xl dark:border-indigo-500/30 dark:bg-slate-950">
        <div className="flex items-center justify-between border-b border-indigo-100/70 px-6 py-5 dark:border-indigo-500/20">
            ...
            <div>
              ...
              <div className="mt-2 flex flex-row gap-2">
                {["online", "invisible"].map((value) => (
                  ...
                  >
                    <span
                      className={`h-3 w-3 rounded-full transition duration-200 ${value === "online" ? "bg-indigo-400" : "bg-slate-400"}`}
                    />
                    <span>
