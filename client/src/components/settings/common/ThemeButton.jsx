...
export function ThemeButton({ isDark, toggleTheme, setIsDark, thick = false }) {
  ...
  return (
    <button
      ...
      className={`mt-1 flex w-full items-center gap-2 rounded-xl border border-transparent px-3 text-start text-indigo-700 transition hover:border-indigo-300 hover:bg-indigo-100 hover:shadow-[0_0_18px_rgba(16,185,129,0.22)] dark:text-indigo-200 dark:hover:border-indigo-500/30 dark:hover:bg-indigo-500/10 ${
