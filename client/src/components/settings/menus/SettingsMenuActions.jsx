...
export function SettingsMenuActions({
  ...
  const accentHover =
    "text-blue-700 transition hover:border-purple-300 hover:bg-purple-50 hover:shadow-[0_0_18px_rgba(168,85,247,0.18)] dark:text-purple-300 dark:hover:border-purple-500/30 dark:hover:bg-purple-500/10";
