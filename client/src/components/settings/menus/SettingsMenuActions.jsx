...
export function SettingsMenuActions({
  ...
  const accentHover =
    "text-emerald-700 transition hover:border-emerald-300 hover:birdx-accent-glow-shadow dark:text-emerald-200 dark:hover:border-emerald-500/30 dark:hover:bg-emerald-500/10";
  ...
  return (
    <>
      ...
      <button
        ...
        className={`mt-1 ${buttonBase} ${accentHover}`}
      >
        <Monitor size={18} className="icon-anim-sway" />
        {t("settings.devices")}
      </button>
      <button
        type="button"
      ...
      <button
        type="button"
        onClick={() => setSettingsPanel("scheduled")}
        className={`mt-1 ${buttonBase} ${accentHover}`}
      >
        <Clock12 size={18} className="icon-anim-sway" />
      ...
      {showAdminPanel ? (
        <button
          type="button"
          onClick={() => onOpenAdmin?.()}
          className={`mt-1 ${buttonBase} border-emerald-200/80 bg-emerald-50/80 text-emerald-800 hover:border-emerald-300 hover:bg-emerald-100 dark:border-emerald-500/30 dark:bg-emerald-500/10 dark:text-emerald-100`}
        >
