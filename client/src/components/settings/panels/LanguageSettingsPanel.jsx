    ...
    >
      <div className="rounded-2xl border border-blue-200/70 bg-white/90 p-4 dark:border-blue-500/30 dark:bg-slate-900/50">
        <div className="flex items-start gap-3">
          <span className="inline-flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-blue-100 text-blue-700 dark:bg-blue-500/15 dark:text-blue-200">
      ...
      <div className="space-y-2">
        <p className="px-1 text-xs font-semibold uppercase tracking-[0.18em] text-blue-600 dark:text-blue-300">
          ...
          return (
            <button
              ...
              className={`flex w-full items-center justify-between gap-3 rounded-2xl border px-4 py-3 text-start transition ${
                active
                  ? "border-blue-400 bg-blue-50 text-blue-700 shadow-sm dark:border-blue-400/70 dark:bg-blue-500/15 dark:text-blue-100"
                  : "border-blue-200/70 bg-white/90 text-slate-700 hover:border-blue-300 hover:bg-blue-50 dark:border-blue-500/30 dark:bg-slate-900/50 dark:text-slate-200 dark:hover:bg-blue-500/10"
              }`}
              lang={item.htmlLang}
              dir={item.dir}
            >
