...
export const DataSettingsPanel = memo(function DataSettingsPanel({
  ...
  const buttonHover =
    "hover:border-indigo-300 hover:bg-indigo-50 dark:hover:bg-indigo-500/10";
  const buttonTheme =
    "border-indigo-200/70 bg-white/90 text-indigo-700 dark:border-indigo-500/30 dark:bg-slate-900/50 dark:text-indigo-200";
  const disabledTheme =
    "cursor-default opacity-70 hover:border-indigo-200/70 hover:bg-white/90 dark:hover:bg-slate-900/50";
  ...
  return (
    ...
    >
      <div className="rounded-2xl border border-indigo-200/70 bg-white/90 px-6 py-5 text-center dark:border-indigo-500/30 dark:bg-slate-900/50">
        <p className="text-[10px] uppercase tracking-[0.25em] text-indigo-500/80">
          {t("settings.data.cachedSize")}
        </p>
        <p
          className={`${isMobile ? "text-2xl" : "text-3xl"} mt-2 font-bold text-indigo-700 dark:text-indigo-200`}
        >
