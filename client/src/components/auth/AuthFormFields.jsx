        ...
        <label className="block">
          ...
          <div className="relative mt-1 sm:mt-2">
            <input
              ...
              className={`w-full rounded-2xl border border-indigo-200 bg-white py-2 text-xs text-slate-700 outline-none transition focus:border-indigo-400 focus:ring-2 focus:ring-indigo-300/60 dark:border-indigo-500/30 dark:bg-slate-950 dark:text-slate-100 sm:py-3 sm:text-sm ${
                nicknameHasPersian
      ...
      <label className="block">
        ...
        <div className="relative mt-1 sm:mt-2">
          <input
            ...
            className="w-full rounded-2xl border border-indigo-200 bg-white px-3 py-2 pr-16 text-xs text-slate-700 outline-none transition focus:border-indigo-400 focus:ring-2 focus:ring-indigo-300/60 dark:border-indigo-500/30 dark:bg-slate-950 dark:text-slate-100 sm:px-4 sm:py-3 sm:pr-20 sm:text-sm"
          />
          <button
            type="button"
