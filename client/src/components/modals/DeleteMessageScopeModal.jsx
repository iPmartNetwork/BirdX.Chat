      ...
      <div className="w-full max-w-sm rounded-2xl border border-rose-100/70 bg-white p-6 shadow-xl dark:border-rose-500/30 dark:bg-slate-950">
        ...
        {allowDeleteForEveryone ? (
          <button
            ...
            className="mt-4 flex w-full items-center justify-between rounded-2xl border border-primary-200/70 bg-white/90 px-4 py-3 text-left text-sm font-semibold text-primary-700 transition hover:border-primary-300 hover:bg-primary-50 hover:shadow-[0_0_18px_rgba(59,130,246,0.18)] dark:border-primary-500/30 dark:bg-slate-900/50 dark:text-primary-200 dark:hover:bg-primary-500/10"
          >
