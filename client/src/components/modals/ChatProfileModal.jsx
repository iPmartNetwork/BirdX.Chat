...
function ChatProfileModal({
  ...
  return createPortal(
    <div className="fixed inset-0 z-[140] flex items-center justify-center bg-black/45 px-5">
      <div className="app-scroll max-h-[calc(100dvh-2rem)] w-full max-w-lg overflow-y-auto rounded-3xl border border-blue-100/70 bg-white p-5 shadow-xl dark:border-blue-500/30 dark:bg-slate-950">
        <div className="mb-3 flex items-center justify-between">
          {!isReadOnly && (isGroup || isChannel) && isOwner ? (
            <button
              type="button"
              onClick={onEditGroup}
              className="inline-flex h-9 w-9 items-center justify-center rounded-full border border-blue-200 bg-white text-blue-700 transition hover:border-blue-300 hover:bg-blue-50 dark:border-blue-500/30 dark:bg-slate-900 dark:text-blue-200 dark:hover:bg-blue-500/10"
        ...
        {showJoinAction ? (
          <div className="mt-4 grid grid-cols-3 gap-2">
            <button
              type="button"
              onClick={onJoinChat}
              className="group col-start-2 rounded-2xl border border-blue-200 bg-white px-2 py-3 text-blue-700 transition hover:border-blue-300 hover:bg-blue-50 dark:border-blue-500/30 dark:bg-slate-900 dark:text-blue-200 dark:hover:bg-blue-500/10"
            >
          ...
          >
            <button
              type="button"
              onClick={onOpenChat}
              className="group rounded-2xl border border-blue-200 bg-white px-2 py-3 text-blue-700 transition hover:border-blue-300 hover:bg-blue-50 dark:border-blue-500/30 dark:bg-slate-900 dark:text-blue-200 dark:hover:bg-blue-500/10"
            >
              <div className="mx-auto inline-flex h-11 w-11 items-center justify-center rounded-full">
        ...
        {!isReadOnly && (isGroup || isChannel) && canViewInvite ? (
          <div className="mt-4 rounded-2xl border border-blue-200 bg-blue-50/70 p-3 dark:border-blue-500/30 dark:bg-blue-500/10">
        ...
        {!isReadOnly && !isSaved ? (
          <div className="mt-4 rounded-2xl border border-blue-200/80 p-3 dark:border-blue-500/30">
            <div className="flex items-center justify-between gap-2">
              <p className="inline-flex items-center gap-1.5 text-xs font-semibold text-blue-700 dark:text-blue-200">
            ...
            <div className="mt-3 space-y-2">
              {safeCallLogs.length ? (
                safeCallLogs.map((call) => {
                  ...
                  return (
                    <div
                      ...
                      className="flex items-center justify-between gap-3 rounded-xl border border-blue-100/80 bg-white/80 px-3 py-2 text-xs dark:border-blue-500/20 dark:bg-slate-900/70"
                    >
                ...
                <p className="rounded-xl border border-dashed border-blue-200 px-3 py-2 text-xs text-slate-500 dark:border-blue-500/30 dark:text-slate-400">
                  No calls yet.
                </p>
              )}
            </div>
          ...
          <div className="mt-4 rounded-2xl border border-blue-200/80 p-3 dark:border-blue-500/30">
            <div className="relative">
              <input
                ...
                className={`w-full rounded-2xl border border-blue-200 bg-white px-4 py-2.5 pr-14 text-sm text-slate-700 outline-none transition focus:border-blue-400 focus:ring-2 focus:ring-blue-300/60 dark:border-blue-500/30 dark:bg-slate-900 dark:text-slate-100 ${
              ...
              {visibleMembers.map((member) => {
                ...
                return (
                  <ContextMenuSurface
                    ...
                    className="flex items-center gap-2 rounded-xl border border-blue-100/80 bg-white/80 px-2 py-2 transition hover:border-blue-300 hover:shadow-[0_0_20px_rgba(59,130,246,0.18)] dark:border-blue-500/20 dark:bg-slate-900/70 dark:hover:border-blue-500/35 dark:hover:shadow-[0_0_18px_rgba(59,130,246,0.12)]"
                    contextMenu={{
                      isMobile:
                  ...
                  >
                    ...
                    {isOwner ? (
                      <label className="inline-flex items-center gap-1 rounded-full border border-blue-200 bg-blue-50 px-2 py-1 text-[10px] font-semibold text-blue-700 dark:border-blue-500/30 dark:bg-blue-500/10 dark:text-blue-200">
                        <ShieldCheck size={11} />
                        <select
                          value={memberRole}
                      ...
                      <span className="rounded-full border border-blue-200 bg-blue-50 px-2 py-0.5 text-[10px] font-semibold capitalize text-blue-700 dark:border-blue-500/30 dark:bg-blue-500/10 dark:text-blue-200">
                        {memberRole}
                      </span>
                    )}
            ...
            {hasMoreMembers ? (
              <button
                ...
                className="mt-2 inline-flex w-full items-center justify-center gap-1 rounded-xl border border-blue-200 bg-white px-3 py-2 text-xs font-semibold text-blue-700 transition hover:border-blue-300 hover:bg-blue-50 hover:shadow-[0_0_14px_rgba(59,130,246,0.2)] dark:border-blue-500/30 dark:bg-slate-900 dark:text-blue-200 dark:hover:bg-blue-500/10"
              >
