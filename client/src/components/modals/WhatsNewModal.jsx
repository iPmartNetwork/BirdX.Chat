  ...
  return createPortal(
    <div className="fixed inset-0 z-[160] flex items-center justify-center bg-slate-950/60 px-4 py-6">
      <div
        ref={panelRef}
        tabIndex={-1}
        className="flex max-h-[min(88vh,52rem)] w-full max-w-2xl flex-col overflow-hidden rounded-[2rem] border border-indigo-100/70 bg-white shadow-2xl outline-none dark:border-indigo-500/30 dark:bg-slate-950"
      >
        <div className="flex items-start justify-between gap-4 border-b border-indigo-100/70 px-6 py-5 dark:border-indigo-500/20">
          <div>
            <p className="text-[10px] uppercase tracking-[0.28em] text-indigo-500/80">
              What's New
            </p>
            <h3 className="mt-2 text-2xl font-bold text-indigo-700 dark:text-indigo-200">
        ...
        <div className="flex items-center justify-between gap-4 border-t border-indigo-100/70 px-6 py-4 dark:border-indigo-500/20">
          {sections.length > 1 ? (
            <div className="flex items-center gap-2">
              <button
                ...
                className="inline-flex h-10 w-10 items-center justify-center overflow-hidden rounded-full border border-indigo-200 bg-white text-indigo-700 transition hover:bg-indigo-50 disabled:cursor-not-allowed disabled:opacity-40 dark:border-indigo-500/30 dark:bg-slate-950 dark:text-indigo-200 dark:hover:bg-indigo-500/10"
