...
export default function GroupInviteLinkModal({ open, inviteLink, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-6">
      <div className="w-full max-w-md rounded-2xl border border-blue-100/70 bg-white p-6 shadow-xl dark:border-blue-500/30 dark:bg-slate-950">
        ...
        <div className="mt-3 rounded-xl border border-blue-200 bg-blue-50/70 p-3 text-xs text-blue-800 dark:border-blue-500/30 dark:bg-blue-500/10 dark:text-blue-200">
