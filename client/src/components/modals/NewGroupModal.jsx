  ...
  return createPortal(
    <>
      <div className="fixed inset-0 z-[140] flex items-center justify-center bg-black/40 px-6">
        <div className="app-scroll max-h-[calc(100dvh-2rem)] w-full max-w-lg overflow-y-auto rounded-2xl border border-blue-100/70 bg-white p-6 shadow-xl dark:border-blue-500/30 dark:bg-slate-950">
          ...
          <div className="mt-4 space-y-3">
            {showAvatarField ? (
              <div className="rounded-2xl border border-blue-200 p-3 dark:border-blue-500/30">
            ...
            <div>
              ...
              <div className="mt-2 grid grid-cols-2 gap-2 rounded-2xl border border-blue-200 p-1 dark:border-blue-500/30">
                <button
                  type="button"
                  onClick={() =>
                  ...
                  className={`rounded-xl px-3 py-2 text-sm font-semibold transition ${
                    safeGroupForm.visibility === "public"
                      ...
                      : "text-slate-700 hover:bg-blue-50 dark:text-slate-200 dark:hover:bg-blue-500/10"
                  }`}
                >
              ...
              {safeGroupForm.visibility === "private" ? (
                <label className="mt-2 inline-flex items-center gap-2 text-xs font-semibold text-slate-700 dark:text-slate-200">
                  <input
                    ...
                    className="h-4 w-4 rounded-full border border-blue-300 bg-white accent-blue-500 focus:ring-2 focus:ring-blue-300 dark:border-blue-500/40 dark:bg-slate-900 dark:accent-blue-400"
                  />
            ...
            {showInviteManagement ? (
              <div className="rounded-2xl border border-blue-200 p-3 dark:border-blue-500/30">
                ...
                <div className="mt-2 rounded-xl border border-blue-200 bg-blue-50/70 p-3 text-xs text-blue-800 dark:border-blue-500/30 dark:bg-blue-500/10 dark:text-blue-200">
                ...
                <div className="mt-3 flex items-center justify-end gap-2">
                  ...
                  <button
                    ...
                    className="inline-flex h-8 items-center gap-2 rounded-full border border-blue-200 bg-white px-3 text-xs font-semibold text-blue-700 transition hover:border-blue-300 hover:bg-blue-50 hover:shadow-[0_0_14px_rgba(59,130,246,0.2)] disabled:opacity-60 dark:border-blue-500/30 dark:bg-slate-900 dark:text-blue-200 dark:hover:bg-blue-500/10"
                  >
                  ...
                  <div className="mt-3 space-y-3">
                    <div>
                      ...
                      <input
                        ...
                        className={`mt-2 w-full rounded-2xl border border-blue-200 bg-white px-4 py-3 text-sm text-slate-700 outline-none transition focus:border-blue-400 focus:ring-2 focus:ring-blue-300/60 dark:border-blue-500/30 dark:bg-slate-900 dark:text-slate-100 ${
                          remoteSourceHasPersian ? "font-fa text-right" : "text-left"
                        }`}
                        style={{ unicodeBidi: "plaintext" }}
                      />
                    </div>
                    <label className="flex items-center justify-between gap-3 rounded-xl border border-blue-100 bg-blue-50/60 px-3 py-2 text-xs font-semibold text-slate-700 dark:border-blue-500/20 dark:bg-blue-500/10 dark:text-slate-200">
                      ...
                      <input
                        ...
                        className="h-4 w-4 rounded border-blue-300 accent-blue-500"
                      />
                    </label>
                    <label className="flex items-center justify-between gap-3 rounded-xl border border-blue-100 bg-blue-50/60 px-3 py-2 text-xs font-semibold text-slate-700 dark:border-blue-500/20 dark:bg-blue-500/10 dark:text-slate-200">
            ...
            <div className="rounded-2xl border border-blue-200 p-3 dark:border-blue-500/30">
              ...
              <div className="relative mt-2">
                <input
                  ...
                  className={`w-full rounded-2xl border border-blue-200 bg-white px-4 py-3 pr-14 text-sm text-slate-700 outline-none transition focus:border-blue-400 focus:ring-2 focus:ring-blue-300/60 dark:border-blue-500/30 dark:bg-slate-900 dark:text-slate-100 ${
                      ...
                      return (
                        <button
                          ...
                          className={`flex w-full items-center gap-3 rounded-2xl border px-3 py-3 text-left text-sm font-medium transition ${
                            selected
                              ? "border-blue-500 border-2 bg-blue-50 text-blue-900 shadow-md dark:border-blue-400 dark:bg-blue-500/20 dark:text-blue-100"
                              : "border-blue-100/70 bg-white/80 text-slate-700 hover:border-blue-300 dark:border-blue-500/30 dark:bg-slate-950 dark:text-slate-200 dark:hover:bg-slate-900/50"
                          }`}
                        >
                          <Avatar
                  ...
                  {safeSelectedMembers.map((member) => {
                    ...
                    return (
                      <button
                        ...
                        className="inline-flex items-center gap-1.5 rounded-full border border-blue-200 bg-blue-50 px-2.5 py-1 text-xs font-semibold text-blue-700 dark:border-blue-500/30 dark:bg-blue-500/10 dark:text-blue-200"
                      >
                        <Avatar
          ...
          <div className="mt-4 flex items-center justify-end gap-2">
            ...
            <button
              ...
              className="inline-flex min-w-[88px] items-center justify-center gap-2 rounded-full bg-blue-500 px-4 py-2 text-xs font-semibold text-white transition hover:bg-blue-400 disabled:opacity-70"
            >
              {creatingGroup ? (
                <>
