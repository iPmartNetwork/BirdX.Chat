...
export default function SidebarHeader({
  ...
  return (
    <div className="border-b border-slate-300/80 bg-white px-6 py-3 dark:border-primary-500/20 dark:bg-slate-900">
      {mobileTab === "settings" ? (
            ...
            <div className="flex items-center gap-2">
              {chatsSearchFocused ? (
                ...
                <button
                  ...
                  onClick={onEnterEdit}
                  disabled={!hasChats}
                  className="inline-flex items-center justify-center rounded-full border border-primary-200 bg-white/80 p-2 text-primary-700 transition hover:border-primary-300 hover:shadow-[0_0_16px_rgba(59,130,246,0.22)] disabled:cursor-not-allowed disabled:opacity-45 disabled:hover:border-primary-200 disabled:hover:shadow-none dark:border-primary-500/30 dark:bg-slate-950 dark:text-primary-200"
              ...
              {chatsSearchFocused ? (
                ...
                <div className="relative" ref={createMenuRef}>
                  <button
                    ...
                    className="inline-flex items-center justify-center rounded-full border border-primary-200 bg-white/80 p-2 text-primary-700 transition hover:border-primary-300 hover:shadow-[0_0_16px_rgba(59,130,246,0.22)] dark:border-primary-500/30 dark:bg-slate-950 dark:text-primary-200"
                    aria-label="Create"
                  ...
                  {showCreateMenu ? (
                    <div className="absolute right-0 top-12 z-20 w-44 rounded-xl border border-primary-200/80 bg-white p-1.5 shadow-lg dark:border-primary-500/30 dark:bg-slate-950">
                      <button
                        type="button"
                        onClick={() => {
                          setShowCreateMenu(false);
          ...
          <div className="mt-3">
            <label className="group relative block">
              {!hasSearchText && !chatsSearchFocused ? (
                <span className="pointer-events-none absolute inset-0 flex items-center justify-center gap-2 text-sm leading-none text-slate-500 transition-colors group-hover:text-slate-600 dark:text-slate-400 dark:group-hover:text-slate-300">
                  <span className="inline-flex -translate-y-[1px] md:translate-y-0">
                    <Search
                      size={14}
                      className="icon-anim-pop block text-primary-600 dark:text-primary-300"
                    />
                  </span>
                  <span>Search</span>
                </span>
              ...
              <input
                ...
                className={`w-full rounded-2xl border border-primary-200 bg-white py-2 pr-10 text-sm text-slate-700 outline-none transition hover:border-primary-300 hover:shadow-[0_0_16px_rgba(59,130,246,0.18)] focus:border-primary-400 focus:bg-white/80 focus:ring-2 focus:ring-primary-300/60 dark:border-primary-500/30 dark:bg-slate-900 dark:text-slate-100 dark:hover:border-primary-500/50 dark:hover:shadow-[0_0_18px_rgba(59,130,246,0.12)] dark:focus:bg-slate-950 ${
                  chatsSearchFocused || hasSearchText
                    ? searchIsRtl
