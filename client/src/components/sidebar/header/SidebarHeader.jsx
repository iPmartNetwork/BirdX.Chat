...
export default function SidebarHeader({
  ...
  return (
    <div className="border-b border-slate-300/80 bg-white px-6 py-3 dark:border-indigo-500/20 dark:bg-slate-900">
      {mobileTab === "settings" ? (
            ...
            <div className="flex justify-end">
              {chatsSearchFocused ? (
                ...
                <div className="relative" ref={createMenuRef}>
                  ...
                  {showCreateMenu ? (
                    <div className="absolute right-0 top-12 z-20 w-44 rounded-xl border border-indigo-200/80 bg-white p-1.5 shadow-lg dark:border-indigo-500/30 dark:bg-slate-950">
                      <button
                        type="button"
                        onClick={() => {
                          setShowCreateMenu(false);
              ...
              {!hasSearchText && !chatsSearchFocused ? (
                <span className="pointer-events-none absolute inset-0 flex items-center justify-center gap-2 text-sm leading-none text-slate-500 transition-colors group-hover:text-slate-600 dark:text-slate-400 dark:group-hover:text-slate-300">
                  <span className="inline-flex -translate-y-[1px] md:translate-y-0">
                    <Search
                      size={14}
                      className="icon-anim-pop block text-indigo-600 dark:text-indigo-300"
                    />
                  </span>
                  <span>Search</span>
                </span>
