...
export default function MobileTabMenu({
  ...
  return (
    ...
    >
      <div className="mx-auto mb-2 flex max-w-sm items-center justify-between rounded-3xl border border-slate-300/90 bg-white/95 p-2 shadow-lg shadow-primary-500/10 backdrop-blur-none dark:border-primary-500/35 dark:bg-slate-900/95 md:backdrop-blur">
        <button
          type="button"
          onClick={onChats}
        ...
        >
          {mobileTab === "chats" ? (
            <span className="absolute inset-0 rounded-2xl bg-primary-500" />
          ) : null}
