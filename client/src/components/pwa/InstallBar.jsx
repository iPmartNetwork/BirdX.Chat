...
const InstallBar = forwardRef(function InstallBar(
  ...
  return (
    <div
      ref={ref}
      className="fixed inset-x-0 top-0 border-b border-primary-200 bg-white/95 shadow-sm shadow-primary-500/10 backdrop-blur dark:border-primary-500/30 dark:bg-slate-950/95"
      style={{
    ...
    >
      <div className="mx-auto flex w-full max-w-6xl items-center justify-between gap-4 px-4 py-3 sm:px-6">
        <div className="flex items-center gap-3">
          ...
          <div className="flex h-10 w-10 items-center justify-center overflow-hidden rounded-2xl border border-primary-200 bg-primary-50 shadow-sm dark:border-primary-500/30 dark:bg-slate-900">
            <img
              src={iconSrc}
              alt="BirdX"
        ...
        <button
          type="button"
          onClick={onInstall}
          className="inline-flex h-8 items-center gap-2 rounded-full bg-primary-500 px-4 text-xs font-semibold text-white shadow-lg shadow-primary-500/30 transition hover:bg-primary-400 hover:shadow-primary-500/40"
        >
